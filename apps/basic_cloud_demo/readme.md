...
The provided GitBash Shell scripts enable easy creation of certificate infrastructure.
It also enables individual device certificate creation just by taking very minical inputs from the user.

These scripts are based on the [Azure Create and Upload Certificates for Testing tutorial](https://learn.microsoft.com/en-us/azure/iot-hub/tutorial-x509-test-certs?tabs=windows).
